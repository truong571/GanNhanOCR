...
# _force_split_to_count() đã xoá: 0 caller. Việc ép số ký tự trong cột về đúng N
# hiện do pipeline/align_engine/char_detector (seam carving + ràng buộc N) đảm nhiệm.
