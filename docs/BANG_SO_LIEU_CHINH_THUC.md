...
<!-- AUTO:HEADER:START -->
**Bộ nhãn sinh ngày**: 2026-08-24 · **Commit chạm bộ nhãn gần nhất**: `5a151401f3` · **Bộ nhãn**: `dataset_out/labels_final.csv` (82.246 dòng)
<!-- AUTO:HEADER:END -->
...
| `dataset_out/labels_remediated.csv` | 82.246 | `76dfb3ecc7d07c08` | `python -m pipeline.remediation --labels dataset_out/labels.csv --out dataset_out apply --tau 0.62` |
| `dataset_out/labels_final.csv` | 82.246 | `73b9c7fb25ecb812` | `python -m pipeline.remediation.confusion_fix … rồi python -m pipeline.remediation.s3_unwind … --apply` |
| `dataset/labels.csv` (**bộ giao nộp**) | **57.067** | `050327f869f817dd` | `python pipeline/export_final_dataset.py --labels dataset_out/labels_final.csv --src-root dataset_out --out dataset` |
<!-- AUTO:NGUON_GOC:END -->
...
**Bộ giao nộp = GOLD + SYLLABLE = 57.067 ô** · 57.067 ảnh đã copy, **0 thiếu**.
<!-- AUTO:PHAN_HANG:END -->
