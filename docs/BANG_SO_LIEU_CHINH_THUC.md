...
<!-- AUTO:HEADER:START -->
**Bộ nhãn sinh ngày**: 2026-08-25 · **Commit chạm bộ nhãn gần nhất**: `5a151401f3` · **Bộ nhãn**: `dataset_out/labels_final.csv` (82.246 dòng)
<!-- AUTO:HEADER:END -->
...
| `dataset/labels.csv` (**bộ giao nộp**) | **57.067** | `f92fbb0f4f7b4851` | `python pipeline/export_final_dataset.py --labels dataset_out/labels_final.csv --src-root dataset_out --out dataset` |
<!-- AUTO:NGUON_GOC:END -->
