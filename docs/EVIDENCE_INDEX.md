...
- sinh lúc: `2026-09-16T13:35:56Z`
- commit  : `ba1980fbb5`
- cây làm việc: 🔴 BẨN (20 tệp đã sửa chưa commit) — commit ở trên KHÔNG
  định danh được mã đã chạy. Muốn tái lập thì phải commit trước khi chạy.
     D dataset_out/.FROZEN
     M dataset_out/CHECKSUMS.txt
     M dataset_out/confusion_fix_report.json
     M dataset_out/decisions_report.json
     M dataset_out/human_audit/khoi_c_2026-09-16/README.md
...
| `dataset_out/labels_final.csv` | `9ea081e9afb9a3d18714c31f65b5f8e43c91396df641cfe14079983a499ffcee` |
| `dataset/labels.csv` | `396481f82461c07f40f856cfb6f98c9c85049b7127d561eb9f9d1884a9340565` |
...
## Lần chạy 2026-09-16T11:38:14Z

sách: STT11 | reseg=detector | config=config/pipeline.yaml
...
## Lần chạy 2026-09-16T14:43:48Z (100% Tự động - Tích hợp Self-Training)
...
| `dataset/labels.csv` | `e153e8187987cce8a5ee84240a91f50b9ec0e167fa4d30e8136352d9bcb838d1` |
| `Dict/QuocNgu_SinoNom.csv` | `e65b98748e13e41f66e1f5527e4b07e7f89ba24522090a4050decab95f1c87d8` |
| `Dict/SinoNom_Similar.csv` | `2ac4cb6dea38e9a6fc544966051d06932c67d918d06c3a0b640ab4b70b9b01b3` |
| `train_crop/detector_r34.best.pt` | `2c119689debfff01a81fee6bf198181c47fe8ab3ccb1eeaa6b576539dd344694` |
| `config/pipeline.yaml` | `c1cfb08d236566f0cdfeb1f767ecf0c97f2e74a9ff1fa64d3bd985035efe2c57` |

## Lần chạy 2026-09-19T19:20:36Z (100% Tự động - Tích hợp Self-Training)
...
## Lần chạy 2026-09-23T09:54:46Z (100% Tự động - Tích hợp Self-Training)
...
## Lần chạy 2026-09-23T12:23:17Z (100% Tự động - Tích hợp Self-Training)
