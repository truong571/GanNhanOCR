"""(i5v2) Bản sao NGUYÊN VĂN train_crop/model_centernet.py — giữ tên tham số để state_dict v1/v2
nạp được vào pipeline (train_crop/infer_centernet.CenterNetDetector). Không sửa.
