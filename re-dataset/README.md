...
**50,156 nhãn cấp KÝ TỰ** + **7,963 chú giải cấp ÂM TIẾT**
= 58,119 dòng · 1,583 lớp chữ · 444 trang · 3,985 cột

> ⚠️ **Đừng phát biểu là "58,119 nhãn".** 7,963 dòng tầng SYLLABLE có cột
...
| `usable_image` | `0` = ảnh trắng hoặc bị cắt mất nét (428 ô). Nhãn có thể vẫn đúng; đừng chấm chiều ảnh ở các ô này |
...
*Sinh tự động từ `labels.csv` ngày 2026-08-25 · commit `47e9aeaa04`*
