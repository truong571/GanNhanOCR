...
# Phép "chỉ mục crop-proto cùng thế hệ" BỎ 16/09 (A-10 giai đoạn 2): S3 tắt, bộ nhãn
# không còn cột split nên rebuild_proto_index nằm ngoài flow v3 (dùng tay --split-hash).

run "3/3 Tái lập: cây làm việc · cache nguyên mẫu · không RNG (T6)" \
