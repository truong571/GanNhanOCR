...
BOOKS: dict[str, dict] = {
    ...
    "KimVanKieu1884": dict(kind="litho", code="kimvankieu1884", prepared="prepared_b1/KimVanKieu1884",
                           labels="prepared_b1/KimVanKieu1884/dataset_out_b1/labels_gated.csv", n_columns=10,
    ...
    "LucVanTien1916": dict(kind="litho", code="lucvantien1916", prepared="prepared_ihr/LucVanTien1916",
                           labels="prepared_ihr/LucVanTien1916/dataset_out/labels_gated.csv", n_columns=10,
                           ihr=True),
    "TruyenKieu1872": dict(kind="litho", code="truyenkieu1872", prepared="prepared_ihr/TruyenKieu1872",
                           labels="prepared_ihr/TruyenKieu1872/dataset_out/labels_gated.csv", n_columns=10,
                           ihr=True),
}
