...
#     -------------------------------------------
#     TỔNG                    685 passed,  0 failed  (mốc 2026-08-25, +43: T4.e + nối cấu hình + T6.b)
#
...
#
# => Con số trích dẫn trong luận văn phải là 685 assertions (685 pass, 0 fail), KHÔNG
...
if [[ ! -d dataset_out/human_audit/audit_combined ]]; then
  ...
  echo "      Dựng mẻ thì tổng sẽ là 645 thay vì 685."
fi
